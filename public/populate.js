...
async function populateProject(response) {
  ...
  data.forEach((project) => {
    ...
    if (project.attributes.liveSiteLink) {
      ...
      liveSiteAnchor.setAttribute("href", project.attributes.liveSiteLink)
      liveSiteLink.appendChild(liveSiteAnchor)

      projectLinks.appendChild(liveSiteLink)
    }

    if (project.attributes.githubLink) {
      ...
      githubAnchor.setAttribute("href", project.attributes.githubLink)
...
// populateProject(fetchData("projects", "populate=screenshots"))
